...
public:
	 ...
	 * @param[in] degree N
	 */
	static void multByMonomial(ZZX &res, ZZX &p, const long monomialDeg,
			const long degree);
	 ...
	 */
	static ZZX multByMonomial(ZZX &p, const long monomialDeg,
			const long degree);
	 ...
	 * @param[in] degree N
	 */
	static void multByMonomialAndEqual(ZZX &p, const long monomialDeg,
			const long degree);
	 ...
	 * @param[in] degree N
	 */
	static void multByConst(ZZX &res, ZZX &p, const ZZ &cnst, ZZ &mod,
			const long degree);
	 ...
	 * @param[in] degree N
	 */
	static void multByConstAndEqual(ZZX &p, const ZZ &cnst, ZZ &mod,
			const long degree);
	 ...
	 * @param[in] degree N
	 */
	static void leftShift(ZZX &res, ZZX &p, const long bits, ZZ &mod,
			const long degree);
	 ...
	 * @param[in] degree N
	 */
	static void leftShiftAndEqual(ZZX &p, const long bits, ZZ &mod,
			const long degree);
	 ...
	 * @param[in] degree N
	 */
	static void rightShift(ZZX &res, ZZX &p, const long bits,
			const long degree);
	 ...
	 * @param[in] degree N
	 */
	static void inpower(ZZX &res, ZZX &p, const long pow, ZZ &mod,
			const long degree);
