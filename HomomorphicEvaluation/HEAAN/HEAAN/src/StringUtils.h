...
public:
	 ...
	 * @param[in] prefix: string prefix
	 */
	static void showcompare(complex<double> val1, complex<double> val2,
			string prefix);
	 ...
	 * @param[in] prefix: string prefix
	 */
	static void showcompare(double *vals1, double *vals2, long size,
			string prefix);
	 ...
	 * @param[in] prefix: string prefix
	 */
	static void showcompare(complex<double> *vals1, complex<double> *vals2,
	 ...
	 * @param[in] prefix: string prefix
	 */
	static void showcompare(double *vals1, double val2, long size,
			string prefix);
	 ...
	 * @param[in] prefix: string prefix
	 */
	static void showcompare(complex<double> *vals1, complex<double> val2,
			long size, string prefix);
	 ...
	 * @param[in] prefix: string prefix
	 */
	static void showcompare(double val1, double *vals2, long size,
			string prefix);
	 ...
	 * @param[in] prefix: string prefix
	 */
	static void showcompare(complex<double> val1, complex<double> *vals2,
			long size, string prefix);
